...
RSpec.describe StopTime do
  ...
  before do
    create(:stop_time, agency: agency, stop: stop, trip: trip, departure_time: start_time - 10.minutes)
    create(:stop_time, agency: agency, stop: stop, trip: trip, departure_time: start_time + 10.minutes)
    create(:stop_time, agency: agency, stop: stop, trip: trip, departure_time: end_time - 10.minutes)
    create(:stop_time, agency: agency, stop: stop, trip: trip, departure_time: end_time + 10.minutes)
  end
